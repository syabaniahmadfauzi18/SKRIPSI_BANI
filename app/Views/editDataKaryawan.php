...
<body class="bg-default">
                        ...
                        <form class="mt-3" action="<?= base_url() ?>/updateKaryawan" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2 col-form-label input-group">
                                    <input type="text" class="form-control datepicker text-center border border-secondary" name="ttl" id="ttl" value='<?= $ttl ?>'>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control border border-secondary" name="phone" id="phone" value='<?= $phone ?>'>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Position</label>
                                <div class="col-sm-2">
                                    <select class="form-control border border-secondary" name="position" id="position" value='<?= $posisi ?>'>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control border border-secondary" name="office" id="office" value='<?= $office ?>'>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2 col-form-label input-group">
                                    <input type="text" class="form-control datepicker text-center border border-secondary" name="startdate" id="startdate" value='<?= $startDate ?>'>
                                    <div class="input-group-addon ml-3">
                                        <i class="fa fa-calendar fa-2x" aria-hidden="true"></i>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2 col-form-label input-group">
                                    ...
                                    <input type="text" class="form-control border border-secondary ml-2" name="salary" id="salary" value='<?= $salary ?>'>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end mt-2">
                                <button type="submit" class="btn btn-primary" onclick="UpdateUserData()">Update</button>
                            </div>
                        </form>
                    </b>
                    <hr>
    ...
    <script type="text/javascript">
        function CheckEmployeExist(isExist) {
            if (!isExist) {
                swal({
                    title: "Warning!",
                    ...
                    window.open("/adminMasterData", "_self");
                });
            }
        }
        ...
        function UpdateUserData() {
            swal({
                title: "Success!",
                text: "Anda telah berhasil mengubah data karyawan",
                icon: "success",
                button: "Ok",
            })
        }

        CheckEmployeExist(<?= $isExist ?>);
